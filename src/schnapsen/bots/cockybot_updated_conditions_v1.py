...
class CockyBot(Bot):
    """
    CockyBot plays conservatively until it reaches 30 points and holds 3 trump cards.
    ...
    def get_move(self, perspective: PlayerPerspective, leader_move: Move | None) -> Move:
        ...
        1. Check if we should become cocky (30 pts, 3 trumps).
    ...
    def _should_become_cocky(self, perspective: PlayerPerspective) -> bool:
        ...
        - We have at least 30 points (direct + pending).
        - We have at least 3 trump cards in hand.
        """
        ...
        return total_score >= 30 and len(trumps_in_hand) >= 3
