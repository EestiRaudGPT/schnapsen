...
if __name__ == "__main__":
    analyze_results('cocky_experiment_results_new_2.csv', 'CockyBot')
    analyze_results('rdeep_experiment_results_new_2.csv', 'RDeepBot')
    analyze_results('bully_experiment_results_new_2.csv', 'BullyBot')
